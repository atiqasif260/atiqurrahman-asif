        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="lg:w-3/5 text-center lg:text-left animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              ...
              <a href="/Atiq_Asif_CV.pdf" target="_blank" rel="noopener noreferrer" className="px-8 py-3 rounded-full font-semibold text-sm text-foreground border border-border hover:border-primary hover:shadow-[0_0_20px_-5px_hsl(var(--primary)/0.5)] transition-all">
                Download CV
              </a>
            </div>
